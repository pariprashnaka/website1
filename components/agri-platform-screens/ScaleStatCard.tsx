      ...
      <div className="flex flex-col gap-2.5">
        {tiers.map((t, i) => (
          <div key={t.label} className="flex items-start gap-2.5">
            <div
              className="w-[18px] h-[18px] rounded-full flex items-center justify-center flex-shrink-0 mono text-[10.5px] font-semibold mt-0.5"
            ...
            <div>
              ...
              <div className="text-[10.5px]" style={{ color: "var(--color-text-muted)" }}>{t.detail}</div>
            </div>
          </div>
        ))}
      </div>
