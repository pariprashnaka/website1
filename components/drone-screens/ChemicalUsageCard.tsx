    ...
    <div className="w-full h-full flex flex-col justify-center p-5">
      ...
      <div className="flex items-end gap-4 h-[70px] mb-3">
        <div className="flex-1 flex flex-col items-center justify-end gap-1.5">
          ...
          <span className="text-[9px]" style={{ color: "var(--color-text-muted)" }}>Blanket</span>
        </div>
        <div className="flex-1 flex flex-col items-center justify-end gap-1.5">
          <div className="w-full rounded-t-sm" style={{ height: "72%", background: "var(--color-accent-purple)" }} />
          <span className="text-[9px]" style={{ color: "var(--color-text-muted)" }}>Targeted</span>
        </div>
      </div>
      <div className="mono text-[9px]" style={{ color: "var(--color-text-muted)" }}>
